...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#070912] p-4 text-white relative overflow-hidden flex-col gap-6 cursor-auto">
            ...
            {/* --- ANIME / SCI-FI RUNNING TECH BOT (VP-BOT) ON LOGIN SCREEN --- */}
            <div className="absolute top-8 w-full overflow-hidden h-9 pointer-events-none flex items-center z-20">
                <div className="absolute left-0 flex items-center gap-2.5 px-3.5 py-1 rounded-full bg-indigo-500/10 border border-indigo-400/30 text-indigo-300 shadow-[0_0_20px_rgba(99,102,241,0.3)] animate-tech-walk backdrop-blur-md">
                    ...
                    <span className="text-[9px] font-extrabold uppercase tracking-widest text-cyan-200">
                        ⚡ AI_ASSISTANT // AUTHENTICATION REQUIRED
                    </span>
                </div>
            </div>
            ...
            <div className="w-full max-w-md rounded-[32px] border border-slate-800 bg-[#0d111a] p-8 text-center shadow-2xl glass-card relative z-10">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-inner">
                    <ShieldCheck size={26} />
                </div>
